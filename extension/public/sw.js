const CACHE_NAME = "whynavo-shell-v0.7.0";
...
const APP_SHELL = ["./", "./privacy.html", "./terms.html", "./LICENSE.txt", "./THIRD_PARTY_NOTICES.txt", "./asset-manifest.json", "./app.webmanifest?v=0.7.0", "./icons/icon192.png?v=0.7.0", "./wallpapers/photo/mobile/aurora-lake.webp"];
