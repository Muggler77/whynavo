const CACHE_NAME = "whytab-shell-v0.6.0";
const ICON_CACHE_NAME = "whytab-icons-v1";
const SHELL_CACHE_PREFIX = "whytab-shell-v";
const MAX_SHELL_CACHE_VERSIONS = 2;
const MAX_ICON_CACHE_ENTRIES = 200;
const APP_SHELL = ["./", "./privacy.html", "./terms.html", "./LICENSE.txt", "./THIRD_PARTY_NOTICES.txt", "./asset-manifest.json", "./app.webmanifest?v=0.6.0", "./icons/icon192.png?v=0.6.0", "./wallpapers/photo/mobile/aurora-lake.webp"];
