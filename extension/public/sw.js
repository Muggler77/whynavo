const CACHE_NAME = "whynavo-shell-v0.9.8";
...
const APP_SHELL = ["./", "./privacy.html", "./terms.html", "./LICENSE.txt", "./THIRD_PARTY_NOTICES.txt", "./asset-manifest.json", "./app.webmanifest?v=0.9.8", "./icons/icon192.png?v=0.9.8", "./wallpapers/photo/mobile/lucid-room.jpg"];
