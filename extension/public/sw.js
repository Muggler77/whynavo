const CACHE_NAME = "whynavo-shell-v0.9.21";
...
const APP_SHELL = ["./", "./privacy.html", "./terms.html", "./support.html", "./LICENSE.txt", "./THIRD_PARTY_NOTICES.txt", "./asset-manifest.json", "./app.webmanifest?v=0.9.21", "./icons/icon192.png?v=0.9.21", "./wallpapers/photo/mobile/lucid-room.jpg"];
