...
- Password reset template: branded bilingual whytab template tracked in `docs/supabase-reset-password-email.html`
...
```txt
Reset your whytab password / 重置 whytab 密码
```
...
AUTH_EMAIL_PUBLIC_APP_URL=https://whytab.pages.dev/
```
