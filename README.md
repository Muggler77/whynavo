...
Current release candidate: **0.9.20**. See the [bilingual release notes](docs/releases/0.9.20.md).
...
![WhyNavo 0.9.20 local-first workspace](docs/images/whynavo-0.9.18-store-home.png)
