...
try {
  ...
  assert.doesNotMatch(authConfigurator, /mailer_templates_confirmation_content|mailer_templates_recovery_content/, "the free-tier Auth configurator must not attempt a template write that Supabase rejects without custom SMTP");
